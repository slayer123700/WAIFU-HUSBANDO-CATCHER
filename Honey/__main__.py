...
from Honey import collection, top_global_groups_collection, group_user_totals_collection, user_collection, user_totals_collection, shivuu
from Honey import application, SUPPORT_CHAT, UPDATE_CHAT, db, LOGGER
from Honey.modules import ALL_MODULES
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Honey.modules." + module_name)
